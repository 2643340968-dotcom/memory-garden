...
当前自动化套件共 `20` 项，并额外覆盖统一多媒体 memory schema、文字/图片/音频卡视图模型、verified/prototype 安全约束、1:1:1 shuffle-bag、忙碌语音延后、LUFS 报告、相对 ducking、非阻塞图片预载、音频混音与卡片时长配置、解析式粒子路径、槽位代际复用和 Bloom 资源预算门槛。
